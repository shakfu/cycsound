...
cdef class Csound:
    ...
    def compile_orc(self, str orc) -> int:
        ...
        """
        cdef bytes encoded = orc.encode()
        cdef const char* cstr = encoded
        cdef int result
        cdef cs.CSOUND* ptr = self.ptr
        with nogil:
            result = cs.csoundCompileOrc(ptr, cstr)
        return result
    ...
    def compile_orc_async(self, str orc) -> int:
        ...
        cdef cs.CSOUND* ptr = self.ptr
        with nogil:
            result = cs.csoundCompileOrcAsync(ptr, cstr)
        return result
    ...
    def eval_code(self, str code) -> float:
        ...
        """
        cdef bytes encoded = code.encode()
        cdef const char* cstr = encoded
        cdef cs.MYFLT result
        cdef cs.CSOUND* ptr = self.ptr
        with nogil:
    ...
    def compile_csd(self, str csd_filename) -> int:
        ...
        calls should be:
            ...
            csound.reset()
        """
        cdef bytes encoded = csd_filename.encode()
        cdef const char* cstr = encoded
        cdef int result
        cdef cs.CSOUND* ptr = self.ptr
        with nogil:
            result = cs.csoundCompileCsd(ptr, cstr)
        return result
    ...
    def compile_csd_text(self, str csd_text) -> int:
        ...
        """
        cdef bytes encoded = csd_text.encode()
        cdef const char* cstr = encoded
        cdef int result
        cdef cs.CSOUND* ptr = self.ptr
        with nogil:
            result = cs.csoundCompileCsdText(ptr, cstr)
        return result
    ...
    def perform_ksmps(self) -> int:
        ...
        cdef cs.CSOUND* ptr = self.ptr
        with nogil:
            result = cs.csoundPerformKsmps(ptr)
        return result
    ...
    def perform_buffer(self) -> int:
        ...
        cdef cs.CSOUND* ptr = self.ptr
        with nogil:
            result = cs.csoundPerformBuffer(ptr)
        return result
    ...
    def read_score(self, str score):
        ...
        """
        cdef bytes encoded = score.encode()
        cdef const char* cstr = encoded
        cdef int result
        cdef cs.CSOUND* ptr = self.ptr
        with nogil:
            result = cs.csoundReadScore(ptr, cstr)
        return result
    ...
    def read_score_async(self, str score):
        ...
        cdef cs.CSOUND* ptr = self.ptr
        with nogil:
            cs.csoundReadScoreAsync(ptr, cstr)
    ...
    def message(self, str fmt, *args):
        ...
        _format = fmt % args if args else fmt
        cdef bytes encoded = _format.encode()
        cs.csoundMessage(self.ptr, "%s", <const char*>encoded)
    ...
    def message_special(self, int attr, str fmt, *args):
        ...
        _format = fmt % args if args else fmt
        cdef bytes encoded = _format.encode()
        cs.csoundMessageS(self.ptr, attr, "%s", <const char*>encoded)
...
cdef cs.uintptr_t join_thread(void *thread):
    ...
    """
    cdef cs.uintptr_t result
    with nogil:
        result = cs.csoundJoinThread(thread)
    return result
...
cdef int wait_thread_lock(void *lock, size_t milliseconds):
    ...
    cdef int result
    with nogil:
        result = cs.csoundWaitThreadLock(lock, milliseconds)
    return result
...
cdef int wait_barrier(void *barrier):
    ...
    cdef int result
    with nogil:
        result = cs.csoundWaitBarrier(barrier)
    return result
